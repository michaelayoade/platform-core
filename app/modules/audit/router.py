...
from app.modules.audit.models import AuditLogResponse, AuditLogCreate
...
async def get_audit_logs(
    ...
    return await AuditService.get_audit_logs(
        db, actor_id, event_type, resource_type, resource_id, 
        action, start_date, end_date, skip, limit
    )
